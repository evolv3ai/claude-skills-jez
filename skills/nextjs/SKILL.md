...
metadata:
  keywords: [nextjs, next-16, app-router, server-components, server-actions, use-cache, cache-components, async-params, proxy.ts, react-19, turbopack, parallel-routes, default.js]
